---
title: Some Brief Thoughts on AI Writing
description: On using language models, meaningful writing, and the problem of reader trust.
...
I love using language models for research and notemaking. I also love them, sometimes, for the final output. **The key issue with using an LLM as the final step is reader trust**: how can I trust anything in a piece of content if I don't know whether the author or speaker even has the capability to rephrase the LLM gobbledygook in their own words? Leigh could have asked ChatGPT to write that speech from a 50-word prompt, ten minutes before he got up on stage. It's also possible he spent hours writing the speech and just ran it through a chatbot at the very end to make it sound nicer. But there is no way for the reader to know which it is, so I can only assume the worst.
